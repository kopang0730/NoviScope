        ...
        "messages": [
            {
                "content": (
                    ...
                    "summary, demand_assessment, confidence, evidence, risks, next_step. "
            ...
            },
            {
                "content": (
                    ...
                    "the next human-review step before experiments."
                ),
                "role": "user",
            },
        ],
...
def parse_demand_validation_output(raw_content: str) -> DemandValidationOutput:
    try:
        ...
        return DemandValidationOutput.model_validate(
